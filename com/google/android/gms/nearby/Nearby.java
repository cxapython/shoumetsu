...
public final class Nearby {
    ...
    private static final zzd a = new zzby();
    private static final Api<Api.ApiOptions.NoOptions> b = new Api<>("Nearby.BOOTSTRAP_API", zzg.CLIENT_BUILDER, zzg.CLIENT_KEY);
    private static final zze c = new zzg();

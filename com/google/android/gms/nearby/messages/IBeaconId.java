...
public class IBeaconId {
    ...
    public IBeaconId(UUID uuid, short s, short s2) {
        this.a = new zzl(uuid, Short.valueOf(s), Short.valueOf(s2));
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof IBeaconId) {
            return Objects.equal(this.a, ((IBeaconId) obj).a);
        }
        return false;
    }

    public short getMajor() {
        return this.a.zzaf().shortValue();
    }

    public short getMinor() {
        return this.a.zzag().shortValue();
    }

...
public final class zzo extends zzl<DriveId> implements SearchableCollectionMetadataField<DriveId> {
    ...
    public final Collection<DriveId> b_(DataHolder dataHolder, int i, int i2) {
                ...
                synchronized (dataHolder) {
                    ...
                    if (dataHolder2 != null) {
                        ...
                        for (int i4 = 0; i4 < count2; i4++) {
                            ...
                            ((ParentDriveIdSet) hashMap.get(Long.valueOf(dataHolder2.getLong(string, i4, windowIndex2)))).a.add(new zzq(dataHolder2.getString(string3, i4, windowIndex2), dataHolder2.getLong(string2, i4, windowIndex2), 1));
                        }
        ...
        for (zzq zzqVar : ((ParentDriveIdSet) parcelableArrayList.get(i)).a) {

    ...
    public void onCreate(Bundle bundle) {
        try {
            ...
            if (launchIntentForPackage == null) {
                ...
                zzdi.zzaw(valueOf2.length() != 0 ? "No launch activity found for package name: ".concat(valueOf2) : new String("No launch activity found for package name: "));
                return;
            }
            String valueOf3 = String.valueOf(getPackageName());
            zzdi.zzaw(valueOf3.length() != 0 ? "Invoke the launch activity for package name: ".concat(valueOf3) : new String("Invoke the launch activity for package name: "));

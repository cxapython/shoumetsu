...
public class GooglePlayServicesUtilLight {
    ...
    public static boolean a(Context context, String str) {
        ...
        try {
            applicationInfo = context.getPackageManager().getApplicationInfo(str, CacheConfig.DEFAULT_MAX_OBJECT_SIZE_BYTES);
        } catch (PackageManager.NameNotFoundException unused2) {
        }
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        ...
        return a(context, !DeviceProperties.isWearableWithoutPlayStore(context) && !DeviceProperties.zzf(context), i);
    }

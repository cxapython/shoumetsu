...
public enum zzb {
    ...
    CSS_RULE("css_rule"),
    CSS_VALUE("css_value"),
    CURRENCY_CODE(Product.KEY_CURRENCY_CODE),
    ...
    LABEL("label"),
    LANGUAGE("language"),
    LIMIT(net.gree.gamelib.payment.internal.f.b),
    LINK("link"),
    ...
    POSITION("position"),
    PRICES("prices"),
    PRIORITY(Product.KEY_PRIORITY),
    PRODUCT("product"),
    PRODUCT_DATA("product_data"),
    PRODUCT_ID(Product.KEY_ID),
    ...
    TITLE(net.gree.gamelib.payment.internal.a.e.N),
    ...
    TYPE(net.gree.gamelib.payment.internal.a.e.J),

...
public class DeviceInfo {
    ...
    private String getAppInstallTime(Context context) {
        try {
            return Util.dateFormatter.format(new Date(context.getPackageManager().getPackageInfo(context.getPackageName(), Connections.MAX_RELIABLE_MESSAGE_LEN).firstInstallTime));
    ...
    private String getAppUpdateTime(Context context) {
        try {
            return Util.dateFormatter.format(new Date(context.getPackageManager().getPackageInfo(context.getPackageName(), Connections.MAX_RELIABLE_MESSAGE_LEN).lastUpdateTime));
        } catch (Exception unused) {
            return null;
        }
    }

...
public final class a extends c {
    ...
    private Product a(String str, Map map) {
        ...
        try {
            ...
            return new ProductBuilder().setSku(str).setProductType(valueOf).setDescription(string).setPrice(optString).setSmallIconUrl(jSONObject.getString("iconUrl")).setTitle(jSONObject.getString(net.gree.gamelib.payment.internal.a.e.N)).setCoinsRewardAmount(jSONObject.optInt("coinsRewardAmount", 0)).build();
        ...
        for (String str2 : this.a) {
            if (!data.containsKey(str2)) {
                ...
                try {
                    ...
                    linkedHashSet.add(str2);
                    String c = c();
                    MetricsHelper.submitJsonParsingExceptionMetrics(c, (String) data.get(str2), b + ".onResult()");
                    String str3 = b;

...
public class ContentTypeField extends AbstractField {
    ...
    private void parse() {
        ...
        try {
            ...
            this.parseException = new org.apache.james.mime4j.field.contenttype.parser.ParseException(e2.getMessage());
        }
    ...
    public org.apache.james.mime4j.field.contenttype.parser.ParseException mo60getParseException() {
        if (!this.parsed) {
            parse();
        }

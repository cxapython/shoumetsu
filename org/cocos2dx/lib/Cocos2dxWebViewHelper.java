...
public class Cocos2dxWebViewHelper {
    ...
    public static boolean canGoBack(final int i) {
        try {
            return ((Boolean) callInMainThread(new Callable<Boolean>() { // from class: org.cocos2dx.lib.Cocos2dxWebViewHelper.7
    ...
    public static boolean canGoForward(final int i) {
        try {
            return ((Boolean) callInMainThread(new Callable<Boolean>() { // from class: org.cocos2dx.lib.Cocos2dxWebViewHelper.8
                @Override // java.util.concurrent.Callable
                /* renamed from: a */
                public Boolean call() {
                    Cocos2dxWebView cocos2dxWebView = (Cocos2dxWebView) Cocos2dxWebViewHelper.webViews.get(i);
    ...
    public static float getOpacityWebView(final int i) {
        if (Build.VERSION.SDK_INT > 10) {
            FutureTask futureTask = new FutureTask(new Callable<Float>() { // from class: org.cocos2dx.lib.Cocos2dxWebViewHelper.17
                @Override // java.util.concurrent.Callable
                /* renamed from: a */
                public Float call() {
                    Object invoke;

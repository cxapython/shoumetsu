...
public class Cocos2dxGLSurfaceView extends GLSurfaceView {
    ...
    public static void queueAccelerometer(final float f, final float f2, final float f3, final long j) {
        mCocos2dxGLSurfaceView.queueEvent(new Runnable() { // from class: org.cocos2dx.lib.Cocos2dxGLSurfaceView.9
                ...
                switch (message.what) {
                    case 2:
                        if (Cocos2dxGLSurfaceView.this.mCocos2dxEditText != null && Cocos2dxGLSurfaceView.this.mCocos2dxEditText.requestFocus()) {
                            ...
                            Cocos2dxGLSurfaceView.this.mCocos2dxEditText.append(str3);
                            Cocos2dxGLSurfaceView.sCocos2dxTextInputWraper.setOriginText(str3);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        switch (motionEvent.getAction() & 255) {
            case 0:
                ...
                runnable = new Runnable() { // from class: org.cocos2dx.lib.Cocos2dxGLSurfaceView.13
                    @Override // java.lang.Runnable
                    public void run() {
            ...
            case 1:
                ...
                runnable = new Runnable() { // from class: org.cocos2dx.lib.Cocos2dxGLSurfaceView.2
                    @Override // java.lang.Runnable
                    public void run() {
                ...
                if (!this.mMultipleTouchEnabled) {
                    for (int i2 = 0; i2 < pointerCount; i2++) {
                        if (iArr[i2] == 0) {
                            ...
                            runnable2 = new Runnable() { // from class: org.cocos2dx.lib.Cocos2dxGLSurfaceView.14
                                @Override // java.lang.Runnable
                                public void run() {
                                    Cocos2dxGLSurfaceView.this.mCocos2dxRenderer.handleActionMove(iArr2, fArr3, fArr4);
                                }
                            };
                        }
                    }
                    ...
                    runnable2 = new Runnable() { // from class: org.cocos2dx.lib.Cocos2dxGLSurfaceView.15
                        @Override // java.lang.Runnable
                        public void run() {
                ...
                if (!this.mMultipleTouchEnabled) {
                    for (int i3 = 0; i3 < pointerCount; i3++) {
                        if (iArr[i3] == 0) {
                            ...
                            runnable2 = new Runnable() { // from class: org.cocos2dx.lib.Cocos2dxGLSurfaceView.3
                                @Override // java.lang.Runnable
                                public void run() {
                                    Cocos2dxGLSurfaceView.this.mCocos2dxRenderer.handleActionCancel(iArr3, fArr5, fArr6);
                                }
                            };
                        }
                    }
                    ...
                    runnable2 = new Runnable() { // from class: org.cocos2dx.lib.Cocos2dxGLSurfaceView.4
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            case 5:
                ...
                if (this.mMultipleTouchEnabled || action == 0) {
                    ...
                    runnable3 = new Runnable() { // from class: org.cocos2dx.lib.Cocos2dxGLSurfaceView.12
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            case 6:
                ...
                if (this.mMultipleTouchEnabled || action2 == 0) {
                    ...
                    runnable3 = new Runnable() { // from class: org.cocos2dx.lib.Cocos2dxGLSurfaceView.16
                        @Override // java.lang.Runnable
                        public void run() {

    ...
    public CloseableHttpClient build() {
        ...
        if (httpClientConnectionManager == null) {
            ...
            if (connectionSocketFactory == null) {
                ...
                connectionSocketFactory = sSLContext != null ? new SSLConnectionSocketFactory(sSLContext, split, split2, hostnameVerifier) : this.systemProperties ? new SSLConnectionSocketFactory((SSLSocketFactory) SSLSocketFactory.getDefault(), split, split2, hostnameVerifier) : new SSLConnectionSocketFactory(SSLContexts.createDefault(), hostnameVerifier);
            }
        ...
        if (httpProcessor == null) {
            ...
            if (!this.contentCompressionDisabled) {
                ...
                create.add(requestAcceptEncoding);
            }

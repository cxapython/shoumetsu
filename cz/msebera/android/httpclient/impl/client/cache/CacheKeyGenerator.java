...
public class CacheKeyGenerator {
    ...
    public String getURI(HttpHost httpHost, HttpRequest httpRequest) {
        return canonicalizeUri(isRelativeRequest(httpRequest) ? String.format("%s%s", httpHost.toString(), httpRequest.getRequestLine().getUri()) : httpRequest.getRequestLine().getUri());
    }

...
public class ResponseCachingPolicy {
    ...
    public ResponseCachingPolicy(long j, boolean z, boolean z2, boolean z3) {
        ...
        this.uncacheableStatuses = z3 ? new HashSet(Arrays.asList(Integer.valueOf((int) HttpStatus.SC_PARTIAL_CONTENT))) : new HashSet(Arrays.asList(Integer.valueOf((int) HttpStatus.SC_PARTIAL_CONTENT), Integer.valueOf((int) HttpStatus.SC_SEE_OTHER)));
    }

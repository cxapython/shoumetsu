...
public class CachingExec implements ClientExecChain {
    ...
    public CloseableHttpResponse revalidateCacheEntry(HttpRoute httpRoute, HttpRequestWrapper httpRequestWrapper, HttpClientContext httpClientContext, HttpExecutionAware httpExecutionAware, HttpCacheEntry httpCacheEntry) {
        Date date;
        ...
        if (statusCode == 304) {
            ...
            return (!this.suitabilityChecker.isConditional(httpRequestWrapper) || !this.suitabilityChecker.allConditionalsMatch(httpRequestWrapper, updateCacheEntry, new Date())) ? this.responseGenerator.generateResponse(httpRequestWrapper, updateCacheEntry) : this.responseGenerator.generateNotModifiedResponse(updateCacheEntry);

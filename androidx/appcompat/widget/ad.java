...
class ad extends androidx.c.a.c implements View.OnClickListener {
    ...
    public ad(Context context, SearchView searchView, SearchableInfo searchableInfo, WeakHashMap<String, Drawable.ConstantState> weakHashMap) {
    ...
    Cursor a(SearchableInfo searchableInfo, String str, int i) {
        ...
        if (i > 0) {
            fragment.appendQueryParameter(net.gree.gamelib.payment.internal.f.b, String.valueOf(i));
        }
